        ...
        stage('Step 2: Run Juice Shop Container') {
            steps {
                script {
                    ...
                    sh 'trufflehog filesystem /var/jenkins_home/workspace/TrufflehogScan/ --config /var/jenkins_home/workspace/TrufflehogScan/config.yaml --json > wynik_skanowania.json'
                    sleep(20)
